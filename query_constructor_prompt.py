...
Your goal is to structure the user's query to match the request schema provided below.
    ...
    ```json
    {
        "content": "Summaries of youtube videos on cryptocurrencies",
        "attributes": {
        "Author": {
    ...
    ```
    In you output use the word 'contain' instead of 'contains'. In no case ever use the word 'contains' use the word 'contain' instead for filter.
