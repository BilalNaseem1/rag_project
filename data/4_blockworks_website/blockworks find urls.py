...
xpath = '//*[@id="__next"]/div/main/section[2]/div/div/div/div/div[2]/div[2]/a'
print(xpath)
...
# Export to CSV
with open('blockworks urls.csv', 'w', newline='') as csvfile:
...
while True:
    scroll_down()
    hrefs = scrape_hrefs()
    with open('blockworks urls.csv', 'a', newline='') as csvfile:
        writer = csv.writer(csvfile)
        for href in hrefs:
            writer.writerow([href])
